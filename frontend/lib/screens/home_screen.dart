...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      // 初始化姿态监测
      try {
        await context.read<PostureProvider>().initialize();
        context.read<PostureProvider>().startMonitoring();
      } catch (e) {
        debugPrint('Failed to initialize posture monitoring: $e');
      }
    });
  }
  ...
  void dispose() {
    ...
    // 停止姿态监测
    context.read<PostureProvider>().stopMonitoring();
    super.dispose();
  }
